package me.caneva20.Core.Command;
...
public class CNVCommands extends CommandBase implements CommandExecutor {
    ...
    public CNVCommands(JavaPlugin plugin, Logger logger) {
        this.plugin = plugin;
        this.logger = logger;
    ...
    public CNVCommands(JavaPlugin plugin, Logger logger, String name) {
        this.plugin = plugin;
        this.logger = logger;
    ...
    public boolean onCommand(CommandSender sender, Command comman, String arg2, String[] args) {
        if (args.length <= 0) {
            args = new String[]{""};
        }
